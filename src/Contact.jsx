...
export default function Contact(){
    return (
       <section className="bg-gray-800 text-gray-100 px-8 pb-12 pt-8">
         <div class="text-center w-full">
        <svg class="text-gray-100 h-8 mx-auto" fill="bg-inherit" viewBox="0 0 150 29" version="1.1">
          <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="Desktop-HD" transform="translate(-1112.000000, -438.000000)" fill="bg-inherit">
